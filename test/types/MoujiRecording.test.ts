import { deserializeRecording, serializeRecording } from "../../src/types/MoujiRecording";
...
describe('MoujiRecording', () => {
    describe('serializeRecording', () => {
        it('should serialize a recording', () => {
            ...
            expect(serialized).toEqual('{"meta":{"interval":10},"points":[[1,2],[3,4]]}');
        });
    });
    ...
    describe('deserializeRecording', () => {
        ...
        it('should throw an error if the recording is invalid', () => {
            const serialized = '{"meta":{"interval":10,"version":1},"points":[[1,2],[3,4]]';
